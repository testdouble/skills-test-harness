...
export async function writeIterationOutput(runDir: string, runId: string, iteration: AcilIterationResult): Promise<void> {
...
export async function writeSummaryOutput(
  ...
  await commonWriteSummaryOutput(runDir, runId, originalDescription, iterations as unknown as WritableIteration[], best as unknown as WritableIteration, 'acil')
}
