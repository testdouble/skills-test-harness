...
describe('splitSets', () => {
  ...
  it('handles NaN holdout without crashing', () => {
    ...
    const result = splitSets('eval', 'p:s', tests, NaN)
  ...
  it('returns empty array for empty input', () => {
    const result = splitSets('eval', 'p:s', [], 0.3)
  ...
  it('handles all-positive tests with holdout', () => {
    ...
    const result = splitSets('eval', 'p:s', tests, 0.3)
    expect(result).toHaveLength(6)
  ...
  // TP-021: Different eval/skill combinations produce different splits
  it('produces different splits for different eval/skill combinations', () => {
  ...
  describe('agent-call type splitting', () => {
    it('getExpectedTrigger handles agent-call expectations', () => {
      ...
      const result = splitSets('eval', 'p:a', tests, 0)
