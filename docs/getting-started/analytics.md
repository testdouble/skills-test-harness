...
- [Viewing Results](viewing-results.md) — using the skillwalker-web dashboard
...
**Related:** [Viewing Results](viewing-results.md) — explore the same data visually in the skillwalker-web dashboard.
